    ...
    <section className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
      <div>
        ...
        <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
          {accountName} · {definition.label} performance measured by Meta Lead events, not unique people. {comparisonInstruction(period, state.meta.mtdComparisonComparable)}
        </p>
      </div>
