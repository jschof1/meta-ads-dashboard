...
export function BusinessOutcomesPanel() {
  ...
  return <section className="mb-6 rounded-xl border p-5" aria-label="Business outcomes">
    ...
    <p className="mt-4 text-sm">Among {data.metaSourcedContacts} new CRM contacts with Facebook/Instagram attribution: {data.metaContactsBooked} booked in this period and {data.metaContactsContacted} are tagged contacted, meaning sales contact happened.</p>
