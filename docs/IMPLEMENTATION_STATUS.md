...
| [05](https://github.com/jschof1/meta-ads-dashboard/pull/15) | Operator dashboard v2 | IN REVIEW | `codex/implement-pr05-from-main/05-operator-dashboard` | PR04 | Live Meta account/token validation remains pending |
