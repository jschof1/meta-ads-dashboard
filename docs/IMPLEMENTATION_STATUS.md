...
| [03](https://github.com/jschof1/meta-ads-dashboard/pull/3) | Durable sync and historical data model | ACTIVE | `codex/implement-pr03-from-main/03-sync-data-model` | PR02 | Meta credentials for end-to-end validation |
