...
| [10](https://github.com/jschof1/meta-ads-dashboard/pull/10) | Production hardening and docs | ACTIVE | `feat/10-production-ready` | PR01–PR09 (PR08 may be explicitly deferred) | Deployment/database access |
